...
const webinarPreheaderStyles = `
      .webinar-preheader {
        --webinar-banner-bg: #202024;
        --webinar-banner-text: #f9fbfc;
        --webinar-banner-muted: #b8bbc1;
        --webinar-banner-chip: rgba(255, 255, 255, 0.08);
        --webinar-banner-line: rgba(255, 255, 255, 0.18);
        --webinar-banner-cta-bg: #f4f4f5;
        --webinar-banner-cta-text: #18181b;
        min-height: 46px;
        color: var(--webinar-banner-text);
        background: var(--webinar-banner-bg);
        transition: background-color 180ms ease, color 180ms ease;
      }
      .webinar-preheader[data-banner-variant="red"] {
        --webinar-banner-bg: #e62334;
        --webinar-banner-text: #fff;
        --webinar-banner-muted: rgba(255, 255, 255, 0.82);
        --webinar-banner-chip: rgba(92, 0, 10, 0.16);
        --webinar-banner-line: rgba(255, 255, 255, 0.3);
        --webinar-banner-cta-bg: #fff;
        --webinar-banner-cta-text: #b31221;
      }
      .webinar-preheader[data-banner-variant="ivory"] {
        --webinar-banner-bg: #eee7dd;
        --webinar-banner-text: #171719;
        --webinar-banner-muted: #69625b;
        --webinar-banner-chip: rgba(255, 255, 255, 0.52);
        --webinar-banner-line: rgba(23, 23, 25, 0.18);
        --webinar-banner-cta-bg: #1f1f22;
        --webinar-banner-cta-text: #fff;
      }
      .webinar-preheader__inner {
      ...
      .webinar-preheader__badge {
        ...
        min-height: 28px;
        padding: 0 10px;
        color: var(--webinar-banner-muted);
        background: var(--webinar-banner-chip);
        border: 1px solid var(--webinar-banner-line);
        border-radius: 9px;
        font-size: 13px;
        font-weight: 500;
        line-height: 1;
      }
      .webinar-preheader__badge svg {
        width: 13px;
        height: 13px;
        color: currentColor;
      }
      .webinar-preheader__divider {
        flex: 0 0 auto;
        width: 1px;
        height: 18px;
        background: var(--webinar-banner-line);
      }
      .webinar-preheader__title {
        min-width: 0;
        margin: 0;
        overflow: hidden;
        color: var(--webinar-banner-text);
      ...
      .webinar-preheader__timer i {
        color: var(--webinar-banner-muted);
        font-size: 13px;
        font-style: normal;
      }
      .webinar-preheader__cta {
        flex: 0 0 auto;
        display: inline-flex;
        align-items: center;
        justify-content: center;
        ...
        min-height: 32px;
        padding: 0 16px;
        color: var(--webinar-banner-cta-text);
        background: var(--webinar-banner-cta-bg);
        border-radius: 999px;
        font-size: 14px;
        font-weight: 500;
        line-height: 1;
      ...
      .webinar-preheader__cta:hover { opacity: 0.9; transform: translateY(-1px); }
      .webinar-preheader__cta:focus-visible {
        outline: 2px solid currentColor;
        outline-offset: 2px;
      }
      .webinar-preheader__cta svg {
        width: 14px;
        height: 14px;
        fill: none;
        stroke: currentColor;
      ...
      @media (max-width: 900px) {
        .webinar-preheader__inner { gap: 10px; }
        .webinar-preheader__badge,
        .webinar-preheader__divider { display: none; }
        .webinar-preheader__title { flex: 1; }
      }
      @media (max-width: 760px) {
        ...
        .webinar-preheader__inner { min-height: 44px; }
        .webinar-preheader__inner { width: calc(100% - 24px); }
        .webinar-preheader__title { font-size: 13px; }
        .webinar-preheader__timer span { min-width: 27px; height: 28px; font-size: 12px; }
        .webinar-preheader__cta { min-height: 30px; padding: 0 12px; font-size: 13px; }
        body .hero.hero--grow { padding-top: 156px; }
      }
      @media (max-width: 560px) {
        .webinar-preheader__timer { display: none; }
        .webinar-preheader__title { font-size: 12px; }
        .webinar-preheader__cta { padding: 0 13px; }
        body .hero.hero--grow { min-height: 584px; padding-top: 132px; }
      }
      @media (prefers-reduced-motion: reduce) {
        .webinar-preheader,
        .webinar-preheader__cta { transition: none; }
      }
`;
...
const platformShowcaseStyles = `
      ...
      .platform-showcase__control[data-platform-tab="pwa"] > img,
      .platform-showcase__control[data-platform-tab="mobile"] > img {
        width: 69.333%;
        margin-top: 10.667%;
      }
      .platform-showcase__control[data-platform-tab="desktop"] > img {
        width: 100%;
      }
      .platform-showcase__control[data-platform-tab="browser"] > img {
        width: 89.333%;
        margin: 8.667% 0 0 10.667%;
      }
      .platform-showcase__control-badges {
        position: absolute;
        z-index: 3;
        bottom: 14px;
        left: 14px;
      ...
      .platform-showcase__control-badge {
        display: block;
        width: 20px;
        height: 20px;
        border-radius: 50%;
      ...
      .platform-showcase__control-badge img {
        display: block;
        width: 20px;
        height: 20px;
        object-fit: contain;
      }
      .platform-showcase__control-pwa {
        position: absolute;
        z-index: 3;
        bottom: 14px;
        left: 14px;
      ...
      .platform-showcase__control-pwa img {
        width: 12px;
        height: 12px;
        filter: brightness(0) invert(1);
      }
      .platform-showcase__exclusive {
        position: absolute;
        z-index: 3;
        top: 14px;
        left: 14px;
      ...
      @media (max-width: 1599px) {
        ...
        .platform-showcase__controls { gap: 10px; height: 511px; }
        .platform-showcase__stage { height: 511px; }
        .platform-showcase__control-badges { bottom: 11px; left: 11px; gap: 5px; }
        .platform-showcase__control-badge,
        .platform-showcase__control-badge img { width: 16px; height: 16px; }
        .platform-showcase__control-pwa { bottom: 11px; left: 11px; transform: scale(.82); transform-origin: bottom left; }
        .platform-showcase__exclusive { top: 11px; left: 11px; transform: scale(.82); transform-origin: top left; }
        .platform-showcase__panel--mobile .platform-showcase__mobile-portrait {
          top: 40px;
          left: 12%;
          width: 368px;
        ...
        .platform-showcase__panel--desktop > img { top: 46px; width: 701px; }
        .platform-showcase__panel--browser > img { width: 780px; }
      }
      ...
      @media (max-width: 1023px) {
        ...
        .platform-showcase__controls { gap: 7px; height: 414px; }
        .platform-showcase__stage { height: 414px; }
        .platform-showcase__control { border-radius: 22px; }
        .platform-showcase__control-badges { bottom: 9px; left: 9px; gap: 4px; }
        .platform-showcase__control-badge,
        .platform-showcase__control-badge img { width: 14px; height: 14px; }
        .platform-showcase__control-pwa { bottom: 9px; left: 9px; transform: scale(.72); }
        .platform-showcase__exclusive { top: 9px; left: 9px; transform: scale(.72); }
        .platform-showcase__panel--mobile .platform-showcase__mobile-portrait {
          top: 32px;
          left: calc(50% - 350px);
          width: 310px;
        ...
        .platform-showcase__panel--desktop > img { top: 39px; width: 493px; }
        .platform-showcase__panel--browser > img { top: 60px; width: 500px; }
      ...
      @media (max-width: 719px) {
        ...
        .platform-showcase__control { flex-basis: 102px; border-radius: 20px; }
        .platform-showcase__control-badges { bottom: 9px; left: 9px; gap: 4px; }
        .platform-showcase__control-badge,
        .platform-showcase__control-badge img { width: 16px; height: 16px; }
        .platform-showcase__control-pwa { bottom: 9px; left: 9px; transform: scale(.76); }
        .platform-showcase__exclusive { top: 9px; left: 9px; transform: scale(.76); }
        .platform-showcase__panel--pwa > img { width: 301px; }
        .platform-showcase__panel--mobile .platform-showcase__mobile-portrait {
          left: calc(50% - 335px);
          width: 300px;
        }
        ...
        .platform-showcase__panel--desktop > img { top: 35px; left: calc(50% + 66px); width: 490px; }
        .platform-showcase__panel--browser > img { top: 90px; width: 400px; }
        .platform-showcase__detail {
          grid-column: 1;
          flex-direction: column;
          align-items: flex-start;
      ...
      @media (max-width: 479px) {
        .platform-showcase { padding: 72px 0; }
        ...
        .platform-showcase__panel--desktop > img { top: 33px; left: calc(50% + 100px); }
        .platform-showcase__panel--browser > img { top: 110px; width: 340px; }
      }
      @media (prefers-reduced-motion: reduce) {
...
const webinarPreheaderMarkup = `
      <aside class="webinar-preheader" data-webinar-preheader data-banner-variant="graphite" data-optimization-mode="split" aria-label="Featured webinar">
        <div class="webinar-preheader__inner">
          <span class="webinar-preheader__badge" aria-hidden="true">
            Webinar
            <svg viewBox="0 0 16 16" aria-hidden="true"><path fill="currentColor" d="M13.7 4.2a2 2 0 0 0-1.4-1.4C11.1 2.5 8 2.5 8 2.5s-3.1 0-4.3.3a2 2 0 0 0-1.4 1.4C2 5.4 2 8 2 8s0 2.6.3 3.8a2 2 0 0 0 1.4 1.4c1.2.3 4.3.3 4.3.3s3.1 0 4.3-.3a2 2 0 0 0 1.4-1.4C14 10.6 14 8 14 8s0-2.6-.3-3.8ZM6.8 10.4V5.6L10.9 8l-4.1 2.4Z"/></svg>
          </span>
          <span class="webinar-preheader__divider" aria-hidden="true"></span>
          <p class="webinar-preheader__title">Can You Vibe Code a Brokerage?</p>
          <span class="webinar-preheader__divider" aria-hidden="true"></span>
          <span class="webinar-preheader__session" data-banner-session>Daily at 12:00 PM GMT+3</span>
          <span class="webinar-preheader__timer" role="timer" aria-live="off" aria-label="Time until the next webinar" data-banner-timer>
            <span data-banner-hours>00</span><i aria-hidden="true">:</i><span data-banner-minutes>00</span><i aria-hidden="true">:</i><span data-banner-seconds>00</span>
          </span>
          <a class="webinar-preheader__cta" href="../vibecode-brokerage-webinar/" data-banner-cta>
        ...
        <div class="platform-showcase__container">
          ...
          <div class="platform-showcase__slider" data-platform-showcase>
            <div class="platform-showcase__controls" role="tablist" aria-label="Trading platform interfaces">
              <button class="platform-showcase__control" id="platform-tab-pwa" type="button" role="tab" aria-label="PWA" aria-selected="true" aria-controls="platform-panel-pwa" data-platform-tab="pwa">
                <img src="./assets/platform-showcase/slide1-thumb.webp" alt="" width="208" height="268" loading="lazy" decoding="async" />
                <span class="platform-showcase__exclusive" aria-hidden="true">Exclusive</span>
                <span class="platform-showcase__control-pwa" aria-hidden="true"><img src="./assets/platform-showcase/browser.svg" alt="" />PWA</span>
              </button>
              <button class="platform-showcase__control" id="platform-tab-mobile" type="button" role="tab" aria-label="Mobile apps" aria-selected="false" aria-controls="platform-panel-mobile" tabindex="-1" data-platform-tab="mobile">
                <img src="./assets/platform-showcase/slide2-thumb.webp" alt="" width="208" height="268" loading="lazy" decoding="async" />
                <span class="platform-showcase__control-badges" aria-hidden="true"><span class="platform-showcase__control-badge"><img src="./assets/platform-showcase/android.svg" alt="" /></span><span class="platform-showcase__control-badge"><img src="./assets/platform-showcase/apple.svg" alt="" /></span></span>
              </button>
              <button class="platform-showcase__control" id="platform-tab-desktop" type="button" role="tab" aria-label="Standalone apps" aria-selected="false" aria-controls="platform-panel-desktop" tabindex="-1" data-platform-tab="desktop">
                <img src="./assets/platform-showcase/slide3-thumb.webp" alt="" width="300" height="300" loading="lazy" decoding="async" />
                <span class="platform-showcase__control-badges" aria-hidden="true"><span class="platform-showcase__control-badge"><img src="./assets/platform-showcase/macos-app-store.webp" alt="" /></span><span class="platform-showcase__control-badge"><img src="./assets/platform-showcase/windows.svg" alt="" /></span></span>
              </button>
              <button class="platform-showcase__control" id="platform-tab-browser" type="button" role="tab" aria-label="Any browser" aria-selected="false" aria-controls="platform-panel-browser" tabindex="-1" data-platform-tab="browser">
                <img src="./assets/platform-showcase/slide4-thumb.webp" alt="" width="268" height="274" loading="lazy" decoding="async" />
                <span class="platform-showcase__control-badges" aria-hidden="true"><span class="platform-showcase__control-badge"><img src="./assets/platform-showcase/chrome.webp" alt="" /></span><span class="platform-showcase__control-badge"><img src="./assets/platform-showcase/safari.webp" alt="" /></span><span class="platform-showcase__control-badge"><img src="./assets/platform-showcase/edge.webp" alt="" /></span><span class="platform-showcase__control-badge"><img src="./assets/platform-showcase/firefox.webp" alt="" /></span></span>
              </button>
            </div>
...
html = stylePrefix + unifiedPageStyles + webinarPreheaderStyles + platformShowcaseStyles + kickstartStyles + html.slice(styleCloseIndex);

const topbarMarker = '    <header class="topbar topbar--grow">';
if (!html.includes(topbarMarker)) throw new Error("Topbar marker not found");
html = html.replace(topbarMarker, `${topbarMarker}\n${webinarPreheaderMarkup}`);
...
html = html.replace(
  "  </body>",
  `${platformShowcaseScript}\n${kickstartScript}\n${calEmbedScript}\n    <script src="./banner-experiment.js?v=20260904-1" defer></script>\n  </body>`,
);
