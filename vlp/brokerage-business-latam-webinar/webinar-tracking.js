(() => {
  ...
  const WEBINAR_KEY = "brokerage_business_latam_daily";
  const REGISTRATION_KEY = "quadcodeLatamWebinarRegistration";
  const PENDING_REGISTRATION_KEY =
    "quadcodeLatamWebinarPendingRegistration";
  const PENDING_ATTENDANCE_KEY = "quadcodeLatamWebinarPendingAttendance";
