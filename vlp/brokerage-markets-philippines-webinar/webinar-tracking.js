(() => {
  ...
  const WEBINAR_KEY = "brokerage_markets_philippines_daily";
  const REGISTRATION_KEY = "quadcodePhilippinesMarketsWebinarRegistration";
  const PENDING_REGISTRATION_KEY =
    "quadcodePhilippinesMarketsWebinarPendingRegistration";
  const PENDING_ATTENDANCE_KEY = "quadcodePhilippinesMarketsWebinarPendingAttendance";
